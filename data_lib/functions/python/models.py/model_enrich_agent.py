...
class Enrichment(BaseModel):
    geo: Optional[Dict[str, str]] = Field(None, description="Geolocation information")
    threat_intel: Optional[Dict[str, str]] = Field(None, description="Threat intelligence details")
...
class ReportSchema(BaseModel):
    ...
    enrichment: Optional[Enrichment] = Field(None, description="Additional enrichment details")

    @validator('chain_of_custody')
